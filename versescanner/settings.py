"""
Django settings for versescanner project.
...
FIXTURE_DIRS = (
    'versescanner/fixtures/deviant/',
    'versescanner/fixtures/metadata/',
)
...
ROOT_URLCONF = 'versescanner.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'versescanner.wsgi.application'
